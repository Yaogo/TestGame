function createUnityInstance(t, r, d) {
    ...
    function U() {
        ...
        c.preRun.push(function() {
            c.addRunDependency("dataUrl"), o.then(function(e) {
    ...
    return c.SystemInfo = function() {
        ...
        return C(e, "", 0), !0
    }, Error.stackTraceLimit = Math.max(Error.stackTraceLimit || 0, 50), c.fetchWithProgress = function(e, t) {
        var c = function() {};
        return t && t.onProgress && (c = t.onProgress), fetch(e, t).then(function(t) {
            ...
            return a || console.warn("[UnityCache] Response is served without Content-Length header. Please reconfigure server to include valid Content-Length for better download performance."),
                function o() {
                    return void 0 === e ? t.arrayBuffer().then(function(e) {
                        return c({
                            type: "progress",
                            total: e.length,
                            loaded: 0,
                        ...
                        if (e.done) {
                            if (l === s) return i;
                            if (l < s) return i.slice(0, l);
                            for (var t = new Uint8Array(l), r = (t.set(i, 0), u), n = 0; n < d.length; ++n) t.set(d[n], r), r += d[n].length;
                            return t
                        }
                        return l + e.value.length <= i.length ? (i.set(e.value, l), u = l + e.value.length) : d.push(e.value), l += e.value.length, c({
                            type: "progress",
                            total: Math.max(s, l),
                            loaded: l,
                            lengthComputable: a
        ...
        name: "WebAssembly",
        version: 1
    }, f = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, S.UnityCacheDatabase = l, S.RequestStore = u, S.WebAssemblyStore = h, p = null, S.getInstance = function() {
        return p = p || new S
    ...
    }, S), c.cachedFetch = (g = c.UnityCache, m = g.RequestStore, b = c.fetchWithProgress, P.prototype.arrayBuffer = function() {
        ...
        function i(e, t) {
            return b(e, t).then(function(e) {
                if (s.enabled && !s.revalidated) {
                    ...
                    200 == e.status ? (s.result = k(e.url, s.company, s.product, s.accessed, e), s.revalidated = !0, a.storeRequest(s.result).then(function() {
